...
class App(ctk.CTk):
    ...
    def __init__(self):
        ...
        # Buttons ---------------------------------------------------------------------------------------------
        self.btn_informar= ctk.CTkButton(master=self, text="Load file", command=self.btn_load_file_on_click)
        self.btn_informar.grid(row=1, padx=10, pady=20, columnspan=2, sticky="nsew")
        ...
        self.btn_mostrar = ctk.CTkButton(master=self, text="Remove task", command=self.btn_remove_on_click)
        self.btn_mostrar.grid(row=3, padx=10, pady=20, columnspan=2, sticky="nsew")

        self.btn_informar= ctk.CTkButton(master=self, text="Replace task", command=self.btn_replace_on_click)
        self.btn_informar.grid(row=5, padx=10, pady=20, columnspan=2, sticky="nsew")
        #-------------------------------------------------------------------------------------------------------
        
        self.t_m1 = TasksManager()
